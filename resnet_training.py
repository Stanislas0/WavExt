...
class dataset:
    def __init__(self, path):
        ...
        self.test_label = np.load(os.path.join(path, "test_label.npy"))


data = dataset("../data/data_original")
x_train, y_train = data.train_data,  data.train_label
x_test, y_test = data.test_data, data.test_label
x_train = np.concatenate([x_train, x_train_wavelet], axis=3)
x_test = np.concatenate([x_test, x_test_wavelet], axis=3)
